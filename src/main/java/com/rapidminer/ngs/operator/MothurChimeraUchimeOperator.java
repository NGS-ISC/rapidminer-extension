...
public class MothurChimeraUchimeOperator extends MothurGeneratedOperator {
	...
	public String getOutputPattern(String type) {
		...
		if (type=="alns") return "[filename],[tag],uchime.alns";
		if (type=="accnos") return "[filename],[tag],uchime.accnos";
		if (type=="count") return "[filename],[tag],uchime.pick.count_table";
		if (type=="chimera") return "[filename],[tag],uchime.chimeras";
		// TODO if nil then 
