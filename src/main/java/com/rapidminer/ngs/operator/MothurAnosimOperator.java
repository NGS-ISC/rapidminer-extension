...
public class MothurAnosimOperator extends MothurGeneratedOperator {
	...
	private OutputPort anosimOutPort = getOutputPorts().createPort("anosim");
	...
	public void doWork() throws OperatorException {
		...
		anosimOutPort.deliver(new FileNameObject(fileName+".anosim","anosim"));
	}
	...
	public String getOutputPattern(String type) {
		...
		if (type=="anosim") return "[filename],anosim";
		// TODO if nil then 
