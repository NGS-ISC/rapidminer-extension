...
public class MothurListOtusOperator extends MothurGeneratedOperator {
	...
	public MothurListOtusOperator (OperatorDescription description) {
		super(description);
	...
	public String getOutputPattern(String type) {
		if (type.equals("accnos")) return "[filename],[distance],accnos-[filename],accnos";
