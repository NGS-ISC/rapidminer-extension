...
public class MothurSffinfoOperator extends MothurGeneratedOperator {
	...
	public String getOutputPattern(String type) {
		...
		if (type=="sff") return "[filename],[group],sff";
		if (type=="qfile") return "[filename],qual-[filename],[tag],qual";
		if (type=="flow") return "[filename],flow";
		if (type=="fasta") return "[filename],fasta-[filename],[tag],fasta";
		if (type=="sfftxt") return "[filename],sff.txt";
		// TODO if nil then 
