...
public class MothurSubSampleOperator extends MothurGeneratedOperator {
	...
	public String getOutputPattern(String type) {
		...
		if (type=="fasta") return "[filename],subsample,[extension]";
		if (type=="taxonomy") return "[filename],subsample,[extension]";
		if (type=="group") return "[filename],subsample,[extension]";
		if (type=="count") return "[filename],subsample,[extension]";
		if (type=="list") return "[filename],[distance],subsample,[extension]";
		if (type=="shared") return "[filename],[distance],subsample,[extension]";
		if (type=="name") return "[filename],subsample,[extension]";
		if (type=="rabund") return "[filename],subsample,[extension]";
		if (type=="sabund") return "[filename],subsample,[extension]";
		// TODO if nil then 
