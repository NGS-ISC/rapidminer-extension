...
public class MothurDeuniqueSeqsOperator extends MothurGeneratedOperator {
	...
	public String getOutputPattern(String type) {
		...
		if (type=="fasta") return "[filename],redundant.fasta";
		if (type=="group") return "[filename],redundant.groups";
		// TODO if nil then 
