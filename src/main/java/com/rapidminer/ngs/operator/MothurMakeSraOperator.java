...
public class MothurMakeSraOperator extends MothurGeneratedOperator {
	...
	public static final String[] INSTRUMENT_CHOICES = { "454_GS", "454_GS_20", "454_GS_FLX", "454_GS_FLX_Titanium", "454_GS_Junior", "Illumina_Genome_Analyzer", "Illumina_Genome_Analyzer_II", "Illumina_Genome_Analyzer_IIx", "Illumina_HiSeq_1000", "Illumina_HiSeq_2000", "Illumina_MiSeq", "Ion_Torrent_PGM", "PacBio_RS", "unspecified" };
	public static final int INSTRUMENT_DEFAULT_CHOICE = 0;
	...
	public static final String[] ORIENTATION_CHOICES = { "forward", "reverse" };
	public static final int ORIENTATION_DEFAULT_CHOICE = 0;
	private static final String ORIENTATION_LABEL = "orientation:";
	private static final String OUTPUTDIR_LABEL = "outputdir:";
	private static final String PDIFFS_LABEL = "pdiffs:";
	public static final String[] PLATFORM_CHOICES = { "ILLUMINA", "ION_TORRENT", "PACBIO_SMRT", "_LS454" };
	public static final int PLATFORM_DEFAULT_CHOICE = 3;
	...
	public String getOutputPattern(String type) {
		...
		if (type=="xml") return "[filename],xml";
		// TODO if nil then 
