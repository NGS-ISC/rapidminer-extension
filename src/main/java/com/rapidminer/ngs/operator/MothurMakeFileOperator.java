...
public class MothurMakeFileOperator extends MothurGeneratedOperator {
	...
	public static final String[] NUMCOLS_CHOICES = { "2", "3" };
	public static final int NUMCOLS_DEFAULT_CHOICE = 1;
	private static final String NUMCOLS_LABEL = "numcols:";
	private static final String OUTPUTDIR_LABEL = "outputdir:";
	private static final String PREFIX_LABEL = "prefix:";
	private static final String SEED_LABEL = "seed:";
	public static final String[] TYPE_CHOICES = { "fastq", "gz" };
	public static final int TYPE_DEFAULT_CHOICE = 0;
	...
	public String getOutputPattern(String type) {
		...
		if (type=="file") return "[filename],[tag],files-[filename],files";
		// TODO if nil then 
