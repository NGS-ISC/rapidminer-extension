...
public class MothurDistSharedOperator extends MothurGeneratedOperator {
	...
	public static final String[] MODE_CHOICES = { "average", "median" };
	public static final int MODE_DEFAULT_CHOICE = 0;
	private static final String MODE_LABEL = "mode:";
	public static final String[] OUTPUT_CHOICES = { "column", "lt", "square" };
	...
	public String getOutputPattern(String type) {
		...
		if (type=="phylip") return "[filename],[calc],[distance],[outputtag],dist-[filename],[calc],[distance],[outputtag],[tag2],dist";
		// TODO if nil then 
