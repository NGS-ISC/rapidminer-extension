...
public class MothurParsimonyOperator extends MothurGeneratedOperator {
	...
	public void doWork() throws OperatorException {
		...
		String randomValue = getParameterAsString(RANDOM_LABEL);
	...
	public List<ParameterType> getParameterTypes() {
		...
		parameterTypes.add(new ParameterTypeString(RANDOM_LABEL, "TODO: Add description", "", true));
	...
	public String getOutputPattern(String type) {
		...
		if (type=="psummary") return "[filename],psummary";
		if (type=="parsimony") return "[filename],parsimony";
		// TODO if nil then 
