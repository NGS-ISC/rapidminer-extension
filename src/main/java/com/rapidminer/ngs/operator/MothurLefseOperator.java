...
public class MothurLefseOperator extends MothurGeneratedOperator {
	...
	public static final String[] MULTICLASS_CHOICES = { "onevall", "onevone" };
	public static final int MULTICLASS_DEFAULT_CHOICE = 0;
	...
	public static final String[] STRICT_CHOICES = { "0", "1", "2" };
	public static final int STRICT_DEFAULT_CHOICE = 0;
	...
	public String getOutputPattern(String type) {
		...
		if (type=="summary") return "[filename],[distance],lefse_summary";
		// TODO if nil then 
