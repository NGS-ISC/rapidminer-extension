...
public class MothurClassifyRfOperator extends MothurGeneratedOperator {
	...
	public static final String[] OTUPERSPLIT_CHOICES = { "log2", "squareroot" };
	public static final int OTUPERSPLIT_DEFAULT_CHOICE = 0;
	...
	public static final String[] SPLITCRITERIA_CHOICES = { "gainratio", "infogain" };
	public static final int SPLITCRITERIA_DEFAULT_CHOICE = 0;
