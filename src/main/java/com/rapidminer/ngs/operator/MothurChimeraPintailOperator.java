...
public class MothurChimeraPintailOperator extends MothurGeneratedOperator {
	...
	public String getOutputPattern(String type) {
		...
		if (type=="chimera") return "[filename],[tag],pintail.chimeras-[filename],pintail.chimeras";
		if (type=="accnos") return "[filename],[tag],pintail.accnos-[filename],pintail.accnos";
		// TODO if nil then 
