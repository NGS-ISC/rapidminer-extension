...
public class MothurRarefactionSharedOperator extends MothurGeneratedOperator {
	...
	public static final String[] CALC_CHOICES = { "sharednseqs", "sharedobserved" };
	public static final int CALC_DEFAULT_CHOICE = 1;
	...
	public String getOutputPattern(String type) {
		...
		if (type=="sharedrarefaction") return "[filename],shared.rarefaction";
		if (type=="sharedr_nseqs") return "[filename],shared.r_nseqs";
		// TODO if nil then 
