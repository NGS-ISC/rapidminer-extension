...
public class MothurUniqueSeqsOperator extends MothurGeneratedOperator {
	...
	public static final String[] FORMAT_CHOICES = { "count", "name" };
	...
	public String getOutputPattern(String type) {
		...
		if (type=="count") return "[filename],count_table-[filename],[tag],count_table";
		if (type=="fasta") return "[filename],unique,[extension]";
		if (type=="name") return "[filename],names-[filename],[tag],names";
		// TODO if nil then 
